...
import java.util.*
 	...
 	// CR Eylon: ✅ Good use of logs to track execution flow and debugging
	// CR Eylon: ✅ Clear structure with well-separated functions
	// CR Eylon: ✅ Uses Firebase Authentication effectively
...
class LoginActivity : BaseActivity() {
    ...
    // CR Eylon: ❗ `idToken` should be checked for `null` before passing it to Firebase.
    // 🔹 If `idToken` is `null`, Firebase authentication will crash the app.
    // 🔹 Suggested fix: Add a safeguard like:
    ...
    // CR Eylon: ❗ This function does two different tasks:
        // 1️⃣ Checks if the user exists in Firestore
        // 2️⃣ Creates a new user if they don’t exist.
        // 💡 It’s better to separate these into two functions:
        // - `checkIfUserExists()`
